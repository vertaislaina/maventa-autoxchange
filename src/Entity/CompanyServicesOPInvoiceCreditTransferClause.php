...
/**
 * CompanyServicesOPInvoiceCreditTransferClause Class Doc Comment
 *
 * @category Class
 * @package  Vertaislaina\Maventa\AutoXChange
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyServicesOPInvoiceCreditTransferClause implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanyServices_OPInvoiceCreditTransferClause';
     ...
     * Sets languageCode
     *
     * @param string $languageCode Language of the transfer clause
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param string $content Contents/text of the transfer clause
     *
     * @return $this
     */
