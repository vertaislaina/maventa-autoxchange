...
/**
 * CompanySettingsDataflyt Class Doc Comment
 *
 * @category Class
 * @package  Vertaislaina\Maventa\AutoXChange
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanySettingsDataflyt implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompanySettings_Dataflyt';
     ...
     * Sets credentials
     *
     * @param bool $credentials Indicates if the accounting office has set the credentials for Landbrukets Dataflyt
     *
     * @return $this
     */
