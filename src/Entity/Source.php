...
class Source implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'names' => '\Vertaislaina\Maventa\AutoXChange\Entity\Translation[]'
    ];
     ...
     * Sets names
     *
     * @param \Vertaislaina\Maventa\AutoXChange\Entity\Translation[] $names Source name, translated in all supported languages
     *
     * @return $this
     */
