...
/**
 * PutV1InvoicesIdRerouteEinvoice Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PutV1InvoicesIdRerouteEinvoice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'putV1InvoicesIdRerouteEinvoice';
    ...
    protected static $attributeMap = [
        'recipientEia' => 'recipient_eia',
        'recipientOperator' => 'recipient_operator'
    ];
    ...
    protected static $setters = [
        'recipientEia' => 'setRecipientEia',
        'recipientOperator' => 'setRecipientOperator'
    ];
    ...
    protected static $getters = [
        'recipientEia' => 'getRecipientEia',
        'recipientOperator' => 'getRecipientOperator'
    ];
    ...
    {
        $this->container['recipientEia'] = isset($data['recipientEia']) ? $data['recipientEia'] : null;
        $this->container['recipientOperator'] = isset($data['recipientOperator']) ? $data['recipientOperator'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recipientEia'] === null) {
            $invalidProperties[] = "'recipientEia' can't be null";
        }
        if ($this->container['recipientOperator'] === null) {
            $invalidProperties[] = "'recipientOperator' can't be null";
        }
    ...
    {
        return $this->container['recipientEia'];
    }

    /**
     * Sets recipientEia
     *
     * @param string $recipientEia Recipient electronic invoice address
     *
     * @return $this
     */
    public function setRecipientEia($recipientEia)
    {
        $this->container['recipientEia'] = $recipientEia;

        return $this;
    }

    /**
     * Gets recipientOperator
     *
     * @return string
     */
    public function getRecipientOperator()
    {
        return $this->container['recipientOperator'];
    }

    /**
     * Sets recipientOperator
     *
     * @param string $recipientOperator Recipient operator
     *
     * @return $this
     */
    public function setRecipientOperator($recipientOperator)
    {
        $this->container['recipientOperator'] = $recipientOperator;
