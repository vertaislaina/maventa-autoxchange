...
/**
 * DocumentRecipientParty Class Doc Comment
 *
 * @category Class
 * @package  Vertaislaina\Maventa\AutoXChange
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentRecipientParty implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocumentRecipientParty';
     ...
     * Sets operator
     *
     * @param string $operator Company operator
     *
     * @return $this
     */
