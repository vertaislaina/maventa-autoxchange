...
/**
 * PatchV1Documents Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PatchV1Documents implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'patchV1Documents';
     ...
     * Sets status
     *
     * @param string $status Change the state of the document.                                       Possible values: CONFIRMED_DELIVERY
     *
     * @return $this
     */
