...
/**
 * PutV1ServicesReceivablesBillingAddress Class Doc Comment
 *
 * @category Class
 * @package  Vertaislaina\Maventa\AutoXChange
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PutV1ServicesReceivablesBillingAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'putV1ServicesReceivables_billing_address';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['streets'] === null) {
            $invalidProperties[] = "'streets' can't be null";
        }
