...
/**
 * OPInvoiceCreditBankDetails Class Doc Comment
 *
 * @category Class
 * @package  Vertaislaina\Maventa\AutoXChange
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OPInvoiceCreditBankDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OPInvoiceCreditBankDetails';
    ...
    protected static $swaggerTypes = [
        'iban' => 'string',
        'bic' => 'string',
        'transferClause' => '\Vertaislaina\Maventa\AutoXChange\Entity\CompanyServicesOPInvoiceCreditTransferClause'
    ];
    ...
    protected static $attributeMap = [
        'iban' => 'iban',
        'bic' => 'bic',
        'transferClause' => 'transfer_clause'
    ];
    ...
    protected static $setters = [
        'iban' => 'setIban',
        'bic' => 'setBic',
        'transferClause' => 'setTransferClause'
    ];
    ...
    protected static $getters = [
        'iban' => 'getIban',
        'bic' => 'getBic',
        'transferClause' => 'getTransferClause'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transferClause'] = isset($data['transferClause']) ? $data['transferClause'] : null;
    }
     ...
     * Sets iban
     *
     * @param string $iban OP IBAN to be used on invoices
     *
     * @return $this
     */
     ...
     * Sets bic
     *
     * @param string $bic OP BIC to be used on invoices
     *
     * @return $this
     */
     ...
     * Gets transferClause
     *
     * @return \Vertaislaina\Maventa\AutoXChange\Entity\CompanyServicesOPInvoiceCreditTransferClause
     */
    public function getTransferClause()
    {
        return $this->container['transferClause'];
    }

    /**
     * Sets transferClause
     *
     * @param \Vertaislaina\Maventa\AutoXChange\Entity\CompanyServicesOPInvoiceCreditTransferClause $transferClause Transfer clause to be used on invoices
     *
     * @return $this
     */
    public function setTransferClause($transferClause)
    {
        $this->container['transferClause'] = $transferClause;
