...
class CompanyApi
{
     ...
     * @throws \Vertaislaina\Maventa\AutoXChange\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Vertaislaina\Maventa\AutoXChange\Entity\CompanySettingsSettings
     */
     ...
     * @throws \Vertaislaina\Maventa\AutoXChange\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Vertaislaina\Maventa\AutoXChange\Entity\CompanySettingsSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getV1CompanySettingsWithHttpInfo($fields = null)
    {
        $returnType = '\Vertaislaina\Maventa\AutoXChange\Entity\CompanySettingsSettings';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Vertaislaina\Maventa\AutoXChange\Entity\CompanySettingsSettings',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
