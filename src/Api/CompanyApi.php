...
class CompanyApi
{
     ...
     *
     * @param  string[] $fields Filter the response to only include requested fields.                                     Possible values: dataflyt_link, dataflyt, invoice_notifications, send_invoice_email, address, details, send_invoice_print, send_invoice_general, logos, checks, email_reports (optional)
     *
     * @throws \Vertaislaina\Maventa\AutoXChange\ApiException on non-2xx response
     * @throws \InvalidArgumentException
