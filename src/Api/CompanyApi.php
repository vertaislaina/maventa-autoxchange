...
class CompanyApi
{
     ...
     */
    public function getV1CompanyMandates($query = null, $timestamp = null, $page = '1', $perPage = '20')
    {
        list($response) = $this->getV1CompanyMandatesWithHttpInfo($query, $timestamp, $page, $perPage);
        return $response;
    }
     ...
     */
    public function getV1CompanyMandatesWithHttpInfo($query = null, $timestamp = null, $page = '1', $perPage = '20')
    {
        $returnType = '\Vertaislaina\Maventa\AutoXChange\Entity\Mandate[]';
        $request = $this->getV1CompanyMandatesRequest($query, $timestamp, $page, $perPage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV1CompanyMandatesAsync($query = null, $timestamp = null, $page = '1', $perPage = '20')
    {
        return $this->getV1CompanyMandatesAsyncWithHttpInfo($query, $timestamp, $page, $perPage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getV1CompanyMandatesAsyncWithHttpInfo($query = null, $timestamp = null, $page = '1', $perPage = '20')
    {
        $returnType = '\Vertaislaina\Maventa\AutoXChange\Entity\Mandate[]';
        $request = $this->getV1CompanyMandatesRequest($query, $timestamp, $page, $perPage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getV1CompanyMandatesRequest($query = null, $timestamp = null, $page = '1', $perPage = '20')
    {
