...
class StatusApi
{
    ...
    /**
     * Operation getStatusAuthenticated
     *
     ...
     * @return \Vertaislaina\Maventa\AutoXChange\Entity\Status
     */
    public function getStatusAuthenticated()
    {
        list($response) = $this->getStatusAuthenticatedWithHttpInfo();
        return $response;
    }

    /**
     * Operation getStatusAuthenticatedWithHttpInfo
     *
     * Status requiring authentication
     *
     *
     * @throws \Vertaislaina\Maventa\AutoXChange\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Vertaislaina\Maventa\AutoXChange\Entity\Status, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatusAuthenticatedWithHttpInfo()
    {
        $returnType = '\Vertaislaina\Maventa\AutoXChange\Entity\Status';
        $request = $this->getStatusAuthenticatedRequest();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Vertaislaina\Maventa\AutoXChange\Entity\Status',
    ...
    /**
     * Operation getStatusAuthenticatedAsync
     *
     * Status requiring authentication
     *
     *
     ...
     */
    public function getStatusAuthenticatedAsync()
    {
        return $this->getStatusAuthenticatedAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStatusAuthenticatedAsyncWithHttpInfo
     *
     * Status requiring authentication
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatusAuthenticatedAsyncWithHttpInfo()
    {
        $returnType = '\Vertaislaina\Maventa\AutoXChange\Entity\Status';
        $request = $this->getStatusAuthenticatedRequest();
    ...
    /**
     * Create request for operation 'getStatusAuthenticated'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStatusAuthenticatedRequest()
    {

        $resourcePath = '/status/authenticated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
