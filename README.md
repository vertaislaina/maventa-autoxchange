...
------------ | ------------- | ------------- | -------------
*AnalysisApi* | [**getV1AnalysisDefinitions**](docs/Api/AnalysisApi.md#getv1analysisdefinitions) | **GET** /v1/analysis/definitions | 
...
*InvoicesApi* | [**deleteV1InvoicesIdReportsReportId**](docs/Api/InvoicesApi.md#deletev1invoicesidreportsreportid) | **DELETE** /v1/invoices/{id}/reports/{report_id} | 
...
*InvoicesApi* | [**getV1InvoicesIdReports**](docs/Api/InvoicesApi.md#getv1invoicesidreports) | **GET** /v1/invoices/{id}/reports | 
*InvoicesApi* | [**postV1Invoices**](docs/Api/InvoicesApi.md#postv1invoices) | **POST** /v1/invoices | Upload new invoice
*InvoicesApi* | [**postV1InvoicesIdReports**](docs/Api/InvoicesApi.md#postv1invoicesidreports) | **POST** /v1/invoices/{id}/reports | 
*InvoicesApi* | [**putV1InvoicesIdRerouteEinvoice**](docs/Api/InvoicesApi.md#putv1invoicesidrerouteeinvoice) | **PUT** /v1/invoices/{id}/reroute/einvoice | 
*InvoicesApi* | [**putV1InvoicesIdRerouteEmail**](docs/Api/InvoicesApi.md#putv1invoicesidrerouteemail) | **PUT** /v1/invoices/{id}/reroute/email | 
*InvoicesApi* | [**putV1InvoicesIdReroutePrint**](docs/Api/InvoicesApi.md#putv1invoicesidrerouteprint) | **PUT** /v1/invoices/{id}/reroute/print | 
...
*OperatorApi* | [**getV1OperatorCompanies**](docs/Api/OperatorApi.md#getv1operatorcompanies) | **GET** /v1/operator/companies | 
...
*ServicesApi* | [**getV1ServicesOpInvoiceCredit**](docs/Api/ServicesApi.md#getv1servicesopinvoicecredit) | **GET** /v1/services/op_invoice_credit | Current information about the OP Laskulaina service
*ServicesApi* | [**getV1ServicesOpInvoiceCreditAccountStatement**](docs/Api/ServicesApi.md#getv1servicesopinvoicecreditaccountstatement) | **GET** /v1/services/op_invoice_credit/account_statement | Fetch account statement
*ServicesApi* | [**getV1ServicesOpInvoiceCreditAvailableCredit**](docs/Api/ServicesApi.md#getv1servicesopinvoicecreditavailablecredit) | **GET** /v1/services/op_invoice_credit/available_credit | Check the credit balance
...
*ServicesApi* | [**postV1ServicesOpInvoiceCreditWithdrawal**](docs/Api/ServicesApi.md#postv1servicesopinvoicecreditwithdrawal) | **POST** /v1/services/op_invoice_credit/withdrawal | Make a withdrawal
*ServicesApi* | [**putV1ServicesOpInvoiceCredit**](docs/Api/ServicesApi.md#putv1servicesopinvoicecredit) | **PUT** /v1/services/op_invoice_credit | Start the OP Laskulaina onboarding
...
## Documentation For Models
 ...
 - [CheckDefinition](docs/Model/CheckDefinition.md)
 - [CheckDefinitions](docs/Model/CheckDefinitions.md)
 ...
 - [CompanyServicesOPInvoiceCreditTransferClause](docs/Model/CompanyServicesOPInvoiceCreditTransferClause.md)
 ...
 - [CompanySettingsCompanyEmailReports](docs/Model/CompanySettingsCompanyEmailReports.md)
 ...
 - [OPInvoiceCredit](docs/Model/OPInvoiceCredit.md)
 - [OPInvoiceCreditAvailableCredit](docs/Model/OPInvoiceCreditAvailableCredit.md)
 - [OPInvoiceCreditBankDetails](docs/Model/OPInvoiceCreditBankDetails.md)
 - [OdpCompany](docs/Model/OdpCompany.md)
 - [OdpService](docs/Model/OdpService.md)
 - [OperatorCompany](docs/Model/OperatorCompany.md)
 ...
 - [PostV1InvoicesIdReports](docs/Model/PostV1InvoicesIdReports.md)
 ...
 - [PostV1ServicesOpInvoiceCreditWithdrawal](docs/Model/PostV1ServicesOpInvoiceCreditWithdrawal.md)
 - [PutV1InvoicesIdRerouteEinvoice](docs/Model/PutV1InvoicesIdRerouteEinvoice.md)
 - [PutV1InvoicesIdRerouteEmail](docs/Model/PutV1InvoicesIdRerouteEmail.md)
 - [PutV1InvoicesIdReroutePrint](docs/Model/PutV1InvoicesIdReroutePrint.md)
 - [PutV1ServicesOpInvoiceCredit](docs/Model/PutV1ServicesOpInvoiceCredit.md)
 ...
 - [ResultDefinition](docs/Model/ResultDefinition.md)
 ...
 - [WarningListMetadata](docs/Model/WarningListMetadata.md)
